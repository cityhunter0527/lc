...
//
TreeNode* RBTree::BSTInsert(TreeNode* n, TreeNode* p) {
...
TreeNode* RBTree::BSTLookup(TreeNode* r, const int key) {
...
// ............b. Setting x to root to exit while loop;
// 
...
TreeNode* RBTree::minimum(TreeNode* u) {
